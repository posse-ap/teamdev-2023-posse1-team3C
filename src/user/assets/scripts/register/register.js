...
// 送信ボタンを活性化させる関数
// const checkInput = () => {
//   if(lastName.value !== '' && firstName.value !== '' && lastNameKana.value !== '' && firstNameKana.value !== '' && sex.value !== '' && graduate.value !== '' && university.value !== '' && faculty.value !== '' && department.value !== '' && prefecture.value !== '' && phone.value !== '' && email.value !== '') {
