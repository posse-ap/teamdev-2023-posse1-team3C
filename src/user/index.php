  ...
  <main>
      ...
      <div class="step-container">
        <div class="step step-1">
          ...
          <div class="step-1-title">
            ...
            <p class="step-1-text">
              <span>絞りこみ検索</span>を使って、自分に合った*****を探すことができます。
              <br>
        ...
        <div class="step step-2">
          ...
          <div class="step-2-title">
            ...
            <p class="step-2-text">
              企業一覧で気になった*****の<span>詳細ページ</span>に飛んでみよう！
              <br>
          ...
          <div class="swiper-slide">
            <div class="user-1-contents">
              ...
              <div class="user-1-comment">
                ...
                <p>
                  *****やアドバイザーの人たちとの相性を確認したかったので、babguでいろんな*****の方とお話しして自分に合う*****を選びました。<span>内定速度や業界特化など様々な観点から比較できた</span>ので、自分にあったアドバイザーの人と出会うことができて無事就活を乗り越えることができました！
                </p>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="user-2-contents">
              ...
              <div class="user-2-comment">
                ...
                <p>
                  就活がうまくいかなかった私は、時間の制約もある中、babguを利用して<span>内定のスピードや面接対策に重点</span>を置いた最適な就活*****を見つけることができました。さらに、*****企業の対応時間も比較することができたため、<span>平日の日中が忙しい私にも合った*****</span>を見つけることができました。就活においては、*****企業に相談してからわずか3週間で内定を得ることができました。
                </p>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="user-3-contents">
              ...
              <div class="user-3-comment">
                ...
                <p>
                  元々<span>コミュニケーションや言語化が苦手</span>な私はES添削や面接対策などのサポートが手厚い企業を探していました。babguではさまざまな項目を比較した上、<span>実際に話をする</span>ことで、本当に自分に合った*****を選ぶことができました。その結果、苦手意識のあった面接でも手応えを感じ、第一志望の企業から内定をいただくことができました！
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="common-question-contents">
      ...
      <div class="question-1">
        ...
        <div class="question-answer" id="q1-answer">
          ...
          <p class="answer-contents">
            いいえ、申し込みをすると*****に登録されるわけではありません。申し込みをすると、*****と対話するためのコンタクトをとることができます。
          </p>
        </div>
      </div>
      ...
      <div class="question-3">
        <div class="question-title" id="q3-question">
          ...
          <p class="question-contents">
            自分に合った時間帯に相談できる就職*****を探したいです。どうしたらいいですか？
          </p>
          <i class="fa-solid fa-caret-down"></i>
        </div>
      ...
      <div class="question-5">
        <div class="question-title" id="q5-question">
          ...
          <p class="question-contents">
            サイト上での申し込み後、*****企業との話し合いはどのように進められますか？
          </p>
          <i class="fa-solid fa-caret-down"></i>
        </div>
        <div class="question-answer" id="q5-answer">
          ...
          <p class="answer-contents">
            登録されたメールなどの連絡先に登録企業から連絡が来ますので、そちらから*****企業とコンタクトをとることができます。その後、お互いの都合の良い日時を決めて、面談を行うことで、本当に自分に合った*****企業か確かめることができます。
          </p>
        </div>
      </div>
      <div class="question-6">
        ...
        <div class="question-answer" id="q6-answer">
          ...
          <p class="answer-contents">
            いいえ、*****企業を利用するのに料金は発生しません。*****企業は企業から報酬を受け取ることで運営されています。また、babgu上での登録などにも料金は発生しません。
          </p>
        </div>
      </div>
      <div class="question-7">
        ...
        <div class="question-answer" id="q7-answer">
          ...
          <p class="answer-contents">
            はい、あります。*****企業の詳細ページには、得意な業界や職種が記載されています。また、企業一覧ページの詳細絞りこみ検索から、得意な業界や職種を選択することで、自分に求めている業界に強い*****企業を探すことができます。
          </p>
        </div>
      </div>
      <div class="question-8">
        ...
        <div class="question-answer" id="q8-answer">
          ...
          <p class="answer-contents">
            いいえ、複数の*****企業を併用することで、より多くの企業と面談を行うことができたり、各*****の強みをバランスよく利用して、より良い就職活動を行うことができます。
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="pop-2">
      <div class="pop-area-2">
        ...
        <div class="pop-2-content">
          *****によって特徴が違うため、<span>自分にあった</span>就活*****選びが非常に重要です。
        </div>
        <div class="pop-2-btn">
    ...
    <div class="pop-3">
      <div class="pop-area-3">
        ...
        <h2 class="pop-3-title">就活*****を利用する前に一度話してみよう！</h2>
        <div class="pop-3-img">
          <img src="./assets/img/approach.png" alt="">
        </div>
        <div class="pop-3-content">
          babguで登録後に、*****から連絡がきて話をすることができます。
        </div>
        <div class="pop-3-btn">
          <button>
            <a href="./clientList.php">
              <p class="search-client">*****を探す</p>
              <i class="fa-solid fa-caret-right"></i>
            </a>
          </button>
        </div>
