...
<section class="text-gray-600 body-font relative">
  ...
  <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap w-4/5">
  ...
  <!-- input fields and select element here -->
        ...
        <p class="m-3.5">有効学生数 :  <span class="text-4xl"><?= $valid ?></span>人（無効学生数 : <span class="text-4xl"> <?= $invalid ?> </span> 人)</p>
