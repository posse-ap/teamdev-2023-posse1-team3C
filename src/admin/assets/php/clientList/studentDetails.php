<?php
// 詳細画面に出てくるものを取得
$sql_studentDetail = "SELECT CompaniesStudentsLink.id as id , Name, furigana, sex, graduated_year, university, faculty, department, prefecture, Students.phoneNumber, Students.email, Students.id as student_id, Students.registered_at, CompaniesStudentsLink.company_id, status, company ,Statuses.id as status_id FROM `CompaniesStudentsLink` join Students on CompaniesStudentsLink.Student_id = Students.id
